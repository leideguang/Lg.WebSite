...
{
    public abstract class WebSiteTestBase : AbpIntegratedTestBase
    {
        ...
        protected Task UsingDbContextAsync(Action<WebSiteDbContext> action)
        {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Action<WebSiteDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<WebSiteDbContext>())
